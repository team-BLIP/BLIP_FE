  ...
  (() => {
    var t = {
          ...
          function i(t, e) {
            (this.logStorage = t),
              (this.stringifyObjects =
                !(!e || !e.stringifyObjects) && e.stringifyObjects),
              (this.storeInterval =
        ...
        9319: (t) => {
          ...
          function i() {
            ...
            if (!(e[i] < t.level))
              for (
                var s =
                    !(t.options.disableCallerInfo || n.disableCallerInfo) &&
                    (function () {
                      var t = {
                          methodName: "",
                          fileLocation: "",
                      ...
                      return (
                        ...
                        !n || n.length <= 4
                          ? (0 === r[2].indexOf("log@")
                              ? (t.methodName = r[3].substr(
                                  0,
                                  r[3].indexOf("@")
                                ))
                              : (t.methodName = r[2].substr(
                                  0,
                                  r[2].indexOf("@")
                                )),
                            t)
        ...
        939: (t, e, r) => {
          ...
          function h(t) {
            ...
            if (
              ...
              -1 !== s &&
                ((e.port = i.substring(s + 1)), (i = i.substring(0, s))),
                (e.hostname = i);
            }
            if (
              ((r = new RegExp("^([^?#]*)", "gi")),
          ...
          class x {
            ...
            on(t, e) {
              ...
              return (
                r || ((r = new Set()), this._listeners.set(t, r)),
                r.add(e),
          ...
          class T extends i() {
            ...
            _getParticipantVideo(t) {
              ...
              if (e && e.contentWindow && e.contentWindow.document)
            ...
            _setSize(t, e) {
              const r = I(t),
                n = I(e);
              void 0 !== r &&
                ((this._height = t), (this._frame.style.height = r)),
                void 0 !== n &&
                  ((this._width = e), (this._frame.style.width = n));
            }
            _setupListeners() {
              this._transport.on("event", (t) => {
                ...
                switch (e) {
                  ...
                  case "local-storage-changed":
                    return (
                      s.setItem("jitsiLocalStorage", r.localStorageContent), !0
                    );
                }
                const o = L[e];
          ...
          t.exports =
            ...
            function (t, e, r) {
              ...
              if (i >= o && (!r || v)) n = y(t, 0, o);
                ...
                n = new f(o, g);
                for (
                  var _ = new d(t), E = new d(n), S = h(o, i), O = 0;
                  O < S;
                  O++
                )
                  x(E, O, w(_, O));
        ...
        4644: (t, e, r) => {
          ...
          for (n in U)
            (o = (i = c[n]) && i.prototype) ? (E(o)[N] = i) : (M = !1);
          ...
          var n = r(6080),
            ...
            a = function (t) {
              ...
              return function (r, a, c) {
                for (
                  var u, p = o(r), l = i(p), f = s(l), d = n(a, c);
                  f-- > 0;
        ...
        8227: (t, e, r) => {
          ...
          t.exports = function (t) {
            return (
              o(p, t) || (p[t] = a && o(u, t) ? u[t] : l("Symbol." + t)), p[t]
            );
          };
        },
        4601: (t, e, r) => {
